...
This used to be a separate module, but now the same functionality can be accessed by enabling the `use_private_bucket` parameter on the `s3-cloudfront-staticwebsitehosting` module.

This module remains only for backwards compatibility purposes.
